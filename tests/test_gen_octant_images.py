...
import gen_octant_images as goi
...
class TestRotationMatrixToZ:
    ...
    @pytest.mark.parametrize(
        'label,n', list(goi.OCTANT_DIRECTIONS.items()),
    )
    def test_maps_n_to_z(self, label, n):
        R = goi.rotation_matrix_to_z(n)
    ...
    def test_identity_for_z_hat(self):
        R = goi.rotation_matrix_to_z([0., 0., 1.])
...
class TestRotateSnapdict:
    ...
    def test_coordinates_rotated(self):
        ...
        R = goi.rotation_matrix_to_z([1., 0., 0.])
        result = goi.rotate_snapdict(snapdict, R)
    ...
    def test_original_unchanged(self):
        ...
        R = goi.rotation_matrix_to_z([1., 0., 0.])
        goi.rotate_snapdict(snapdict, R)
...
class TestScanImageDirs:
    ...
    def test_finds_galaxies(self):
        ...
        galaxies = goi.scan_image_dirs(host_dir, sat_dir)
    ...
    def test_deduplicates_by_galaxy_id(self):
        ...
        # produce duplicates.
        host_dir = TEST_DATA_DIR / 'host_band_ugr'
        galaxies = goi.scan_image_dirs(host_dir, host_dir)
        ids = [
